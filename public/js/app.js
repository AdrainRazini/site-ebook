        ...
        books.forEach(livro => {
            ...
            bookDiv.innerHTML = `
                <div class="book-cover">
                    <a href="livros.html?id=${livro.id}"> <!-- Link para a página de leitura -->
                        <img src="${livro.imagem}" alt="${livro.titulo}">
                    </a>
                    <div class="book-title">${livro.titulo}</div>
                </div>
                ...
                <p>${livro.descricao}</p>
                <a href="livros.html?id=${livro.id}" class="btn">Ler</a> <!-- Botão para ler -->
            `;
            booksList.appendChild(bookDiv);
        });
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    menuToggle.addEventListener('click', () => {
        mobileMenu.classList.toggle('show'); // Adiciona ou remove a classe 'show' no menu
    });

    closeMenu.addEventListener('click', () => {
        mobileMenu.classList.remove('show'); // Remove a classe 'show' para ocultar o menu
    });
});
